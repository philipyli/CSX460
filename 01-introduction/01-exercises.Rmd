...
```{r}
  ...
  ex1function <- function(x) {
    ifelse(x==0,
      prod(replace(x, x==0, 1)),           
      prod(x)/x)
  }

  ## running function with sample vector  
  inputVector <- c( 1, 5, 2, 8 )
  ex1function(inputVector)

  ## running function with zeroes in vector
  inputVector <- c( 1, 5, 0, 8 )
  ex1function(inputVector)
